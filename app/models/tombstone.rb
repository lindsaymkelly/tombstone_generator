class Tombstone < ApplicationRecord
  ...
  has_attached_file :acquiror_logo, :storage => :cloudinary, :path => ':id/:style/:filename', styles: { medium: "380x150>", thumb: "100x100>" }
  has_attached_file :acquired_logo, :storage => :cloudinary, :path => ':id/:style/:filename', styles: { medium: "380x100>", thumb: "100x100>" }
